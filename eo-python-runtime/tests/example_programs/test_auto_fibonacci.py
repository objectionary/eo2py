...
# on 2021.06.30 at 14:17:17. Don't edit it,
...
class EOfibonacci(ApplicationMixin, Object):
    ...
    def attr__phi(self):
        return Attribute((Attribute(self.attr_n, "less")(Number(3))), "if")(
            self.attr_small()(self.attr_n))(self.attr_rec()(self.attr_n)(Number(1))(Number(1)))
...
class EOfibonacciEOsmall(ApplicationMixin, Object):
    ...
    @property
    def attr__phi(self):
        return Attribute((Attribute((self.attr_n), "eq")(Number(2))), "if")(Number(1))(
            self.attr_n
        )
...
class EOfibonacciEOrec(ApplicationMixin, Object):
    ...
    def attr__phi(self):
        return Attribute((Attribute((self.attr_n), "eq")(Number(3))), "if")(
            Attribute((self.attr_minus2), "add")(self.attr_minus1)
        )(
