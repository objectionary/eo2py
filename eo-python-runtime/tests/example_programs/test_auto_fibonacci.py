...
# on 2021.06.27 at 18:16:19. Don't edit it,
...
class EOfibonacci(ApplicationMixin, Object):
    ...
    @property
    def attr__phi(self):
        return (Attribute((Attribute((self.attr_n), "less")()(Number(3))), "if")(self.attr_small()(self.attr_n))((
...
class EOfibonacciEOsmall(ApplicationMixin, Object):
    ...
    @property
    def attr__phi(self):
        return (Attribute((Attribute((self.attr_n), "eq")(Number(2))), "if")(Number(1))(self.attr_n))
...
class EOfibonacciEOrec(ApplicationMixin, Object):
    ...
    def __init__(self, attr__parent):
        ...
        self.attributes = ["n", "minus1", "minus2", ]

    @property
    def attr__phi(self):
        return (Attribute((Attribute((self.attr_n), "eq")()(Number(3))), "if")()(
            Attribute((self.attr_minus1), "add")()(self.attr_minus2))(EOfibonacciEOrec(
            (Attribute((self.attr_n), "sub")()(Number(1)))(Attribute((self.attr_minus1), "add")()(self.attr_minus2))(
                self.attr_minus1))))


def test_auto_fibonacci():
    assert Attribute(EOfibonacci(), "small")(Number(10)).dataize() == Number(10)
    assert Attribute(EOfibonacci(), "small")(Number(2)).dataize() == Number(1)
    assert Attribute(EOfibonacci(), "small")(Number(-1)).dataize() == Number(-1)
    # assert EOfibonacci()(Number(10)).dataize() == Number(55)
